...
<head>
    <meta charset="UTF-8">
    <title>Register | Love Wedding</title>
...
<body class="bg-[#fff5f7] min-h-screen flex items-center justify-center p-6">
...
<div class="relative w-full max-w-5xl bg-white rounded-[32px] shadow-2xl overflow-hidden flex">
    ...
    <div class="hidden md:flex w-1/2 bg-gradient-to-br from-pink-500 to-purple-600 p-12 text-white flex-col justify-center">
        ...
        <p class="text-pink-100 text-sm mb-6">
            Daftar sekarang dan nikmati kemudahan merencanakan hari bahagia
            bersama vendor terbaik.
        </p>
    ...
    <div class="w-full md:w-1/2 p-12 flex flex-col justify-center">
        ...
        <form action="<?= base_url('/register-process') ?>" method="post" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="username" required
                    class="w-full px-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-pink-400/30 transition">
            </div>
            ...
            <button
                class="w-full bg-gradient-to-r from-pink-500 to-pink-700 hover:from-pink-600 hover:to-pink-800
                       text-white font-montserrat font-bold py-4 rounded-2xl shadow-lg shadow-pink-200 transition">
                Daftar Sekarang
            </button>
        </form>
        ...
        <p class="text-center text-sm text-gray-500 mt-8">
            Sudah punya akun?
            <a href="<?= base_url('/login') ?>" class="text-pink-600 font-bold hover:underline">
                Login
            </a>
        </p>
    </div>
